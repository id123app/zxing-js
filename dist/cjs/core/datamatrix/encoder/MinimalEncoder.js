...
var MinimalEncoder = /** @class */ (function () {
    ...
    MinimalEncoder.getNumberOfC40Words = function (input, from, c40, characterLength) {
        ...
        for (var i = from; i < input.length(); i++) {
            ...
            if ((c40 && EncoderUtils_1.EncoderUtils.isNativeC40(ci)) ||
                (!c40 && EncoderUtils_1.EncoderUtils.isNativeText(ci))) {
                thirdsCount++; // native
            }
                ...
                if (asciiValue >= 128 &&
                    ((c40 && EncoderUtils_1.EncoderUtils.isNativeC40(asciiValue - 128)) ||
                        (!c40 && EncoderUtils_1.EncoderUtils.isNativeText(asciiValue - 128)))) {
    ...
    MinimalEncoder.addEdges = function (input, edges, from, previous) {
        ...
        if (previous === null || previous.getEndMode() !== Mode.EDF) {
            ...
            // else
            if (EncoderUtils_1.EncoderUtils.isDigit(ch) &&
                input.haveNCharacters(from, 2) &&
                EncoderUtils_1.EncoderUtils.isDigit(input.charAt(from + 1))) {
            ...
            if (input.haveNCharacters(from, 3) &&
                EncoderUtils_1.EncoderUtils.isNativeX12(input.charAt(from)) &&
                EncoderUtils_1.EncoderUtils.isNativeX12(input.charAt(from + 1)) &&
                EncoderUtils_1.EncoderUtils.isNativeX12(input.charAt(from + 2))) {
        ...
        for (i = 0; i < 3; i++) {
            ...
            if (input.haveNCharacters(pos, 1) &&
                EncoderUtils_1.EncoderUtils.isNativeEDIFACT(input.charAt(pos))) {
        ...
        if (i === 3 &&
            ...
            EncoderUtils_1.EncoderUtils.isNativeEDIFACT(input.charAt(from + 3))) {
...
var Edge = /** @class */ (function () {
    ...
    Edge.prototype.getLastASCII = function () {
        ...
        if (length - from === 2) {
            ...
            if (EncoderUtils_1.EncoderUtils.isDigit(this.input.charAt(from)) &&
                EncoderUtils_1.EncoderUtils.isDigit(this.input.charAt(from + 1))) {
                return 1;
            }
            return 2;
        }
        if (length - from === 3) {
            ...
            if (EncoderUtils_1.EncoderUtils.isDigit(this.input.charAt(from + 1)) &&
                EncoderUtils_1.EncoderUtils.isDigit(this.input.charAt(from + 2)) &&
        ...
        if (EncoderUtils_1.EncoderUtils.isDigit(this.input.charAt(from)) &&
            EncoderUtils_1.EncoderUtils.isDigit(this.input.charAt(from + 1)) &&
            EncoderUtils_1.EncoderUtils.isDigit(this.input.charAt(from + 2)) &&
            EncoderUtils_1.EncoderUtils.isDigit(this.input.charAt(from + 3))) {
            return 2;
        }
        return 0;
    };
    ...
    Edge.prototype.getC40Words = function (c40, fnc1) {
        ...
        for (var i = 0; i < this.characterLength; i++) {
            ...
            if ((c40 && EncoderUtils_1.EncoderUtils.isNativeC40(ci)) ||
                ...
                if ((c40 && EncoderUtils_1.EncoderUtils.isNativeC40(asciiValue)) ||
                    (!c40 && EncoderUtils_1.EncoderUtils.isNativeText(asciiValue))) {
