...
var ASCIIEncoder = /** @class */ (function () {
    ...
    ASCIIEncoder.prototype.encode = function (context) {
        // step B
        var n = EncoderUtils_1.EncoderUtils.determineConsecutiveDigitCount(context.getMessage(), context.pos);
        if (n >= 2) {
            ...
            var newMode = EncoderUtils_1.EncoderUtils.lookAheadTest(context.getMessage(), context.pos, this.getEncodingMode());
            ...
            else if (EncoderUtils_1.EncoderUtils.isExtendedASCII(c)) {
    ...
    ASCIIEncoder.prototype.encodeASCIIDigits = function (digit1, digit2) {
        if (EncoderUtils_1.EncoderUtils.isDigit(digit1) && EncoderUtils_1.EncoderUtils.isDigit(digit2)) {
