...
require("./wasmSetup");
var wasmLinearGeometry_1 = require("./internal/wasmLinearGeometry");
/** Mapping from zxing-wasm format strings to BarcodeFormat enum values */
var WASM_FORMAT_TO_BARCODE_FORMAT = {
    'Aztec': BarcodeFormat_1.default.AZTEC,
    'Codabar': BarcodeFormat_1.default.CODABAR,
    'Code39': BarcodeFormat_1.default.CODE_39,
    'Code93': BarcodeFormat_1.default.CODE_93,
    'Code128': BarcodeFormat_1.default.CODE_128,
    'DataBar': BarcodeFormat_1.default.RSS_14,
    'DataBarExpanded': BarcodeFormat_1.default.RSS_EXPANDED,
    'DataMatrix': BarcodeFormat_1.default.DATA_MATRIX,
    'EAN-8': BarcodeFormat_1.default.EAN_8,
    'EAN-13': BarcodeFormat_1.default.EAN_13,
    'ITF': BarcodeFormat_1.default.ITF,
    'PDF417': BarcodeFormat_1.default.PDF_417,
    'QRCode': BarcodeFormat_1.default.QR_CODE,
    'UPC-A': BarcodeFormat_1.default.UPC_A,
    'UPC-E': BarcodeFormat_1.default.UPC_E,
};
/** Mapping from BarcodeFormat enum to zxing-wasm format strings */
var BARCODE_FORMAT_TO_WASM = (_a = {},
    _a[BarcodeFormat_1.default.AZTEC] = 'Aztec',
    _a[BarcodeFormat_1.default.CODABAR] = 'Codabar',
    _a[BarcodeFormat_1.default.CODE_39] = 'Code39',
    _a[BarcodeFormat_1.default.CODE_93] = 'Code93',
    _a[BarcodeFormat_1.default.CODE_128] = 'Code128',
    _a[BarcodeFormat_1.default.RSS_14] = 'DataBar',
    _a[BarcodeFormat_1.default.RSS_EXPANDED] = 'DataBarExpanded',
    _a[BarcodeFormat_1.default.DATA_MATRIX] = 'DataMatrix',
    _a[BarcodeFormat_1.default.EAN_8] = 'EAN-8',
    _a[BarcodeFormat_1.default.EAN_13] = 'EAN-13',
    _a[BarcodeFormat_1.default.ITF] = 'ITF',
    _a[BarcodeFormat_1.default.PDF_417] = 'PDF417',
    _a[BarcodeFormat_1.default.QR_CODE] = 'QRCode',
    _a[BarcodeFormat_1.default.UPC_A] = 'UPC-A',
    _a[BarcodeFormat_1.default.UPC_E] = 'UPC-E',
    _a);
/**
...
var BrowserMultiFormatReader = /** @class */ (function (_super) {
    ...
    BrowserMultiFormatReader.prototype.getWasmFormats = function () {
        ...
        if (!hints)
            return undefined;
        var possibleFormats = hints.get(DecodeHintType_1.default.POSSIBLE_FORMATS);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        possibleFormatsHint = (_a = this._hints) === null || _a === void 0 ? void 0 : _a.get(DecodeHintType_1.default.POSSIBLE_FORMATS);
                    ...
                    case 1:
                        ...
                        runWasm = function (formats) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        raw = (0, reader_1.readBarcodes)(imageData_1, __assign(__assign({}, baseOptions_1), { formats: formats }));
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, runWasm(wasmLinearGeometry_1.DEFAULT_LINEAR_FORMATS)];
                    case 5:
                        results = _b.sent();
                        _b.label = 6;
                    case 6:
                        ...
                        if (!callerProvidedFormatsHint && !(0, wasmLinearGeometry_1.hasValidLinearGeometry)(first)) {
                            throw new NotFoundException_1.default();
                        }
                        points = BrowserMultiFormatReader.extractResultPoints(first, scale);
                        return [2 /*return*/, new Result_1.default(first.text, null, 0, points !== null && points !== void 0 ? points : [], barcodeFormat)];
                    case 7:
                        e_2 = _b.sent();
                        if (e_2 instanceof NotFoundException_1.default) {
    ...
    BrowserMultiFormatReader.extractResultPoints = function (result, scale) {
        ...
        return [
            new ResultPoint_1.default(topLeft.x * invScale, topLeft.y * invScale),
            new ResultPoint_1.default(topRight.x * invScale, topRight.y * invScale),
            new ResultPoint_1.default(bottomRight.x * invScale, bottomRight.y * invScale),
            new ResultPoint_1.default(bottomLeft.x * invScale, bottomLeft.y * invScale),
        ];
    };
