...
var BrowserCodeReader = /** @class */ (function () {
    ...
    Object.defineProperty(BrowserCodeReader.prototype, "isMediaDevicesSupported", {
        /**
     ...
     */
    BrowserCodeReader.prototype.decodeAsync = function (element) {
     ...
     */
    BrowserCodeReader.wrapGetUserMediaError = function (err) {
        if (err instanceof DOMException) {
            switch (err.name) {
                case 'NotAllowedError':
                    return new Error('Camera access denied. Please grant camera permission and try again.');
                case 'NotFoundError':
                    return new Error('No camera found. Please connect a camera device and try again.');
                case 'NotReadableError':
                    return new Error('Camera is already in use by another application.');
                case 'OverconstrainedError':
                    return new Error('Camera does not satisfy the requested constraints (resolution, facing mode, etc.).');
                case 'AbortError':
                    return new Error('Camera access was aborted.');
                case 'SecurityError':
                    return new Error('Camera access requires a secure context (HTTPS). Please load the page over HTTPS.');
            }
        }
        if (err instanceof Error)
            return err;
        return new Error("Failed to access camera: ".concat(String(err)));
    };
    /**
    ...
    BrowserCodeReader.prototype.listVideoInputDevices = function () {
        return __awaiter(this, void 0, void 0, function () {
            var reason, devices, videoDevices, devices_1, devices_1_1, device, kind, deviceId, label, groupId, videoDevice;
            var e_1, _a;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!this.canEnumerateDevices) {
                            ...
                            throw new Error("Can't enumerate devices, ".concat(reason));
                        }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_1 = _a.sent();
                        throw BrowserCodeReader.wrapGetUserMediaError(err_1);
                    case 3: return [4 /*yield*/, this.decodeOnceFromStream(stream, videoSource)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_2 = _a.sent();
                        throw BrowserCodeReader.wrapGetUserMediaError(err_2);
                    case 3: return [4 /*yield*/, this.decodeFromStream(stream, videoSource, callbackFn)];
                    case 4: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    BrowserCodeReader.prototype.getMediaElement = function (mediaElementId, type) {
        ...
        if (!mediaElement) {
            throw new ArgumentException_1.default("element with id '".concat(mediaElementId, "' not found"));
        }
        if (mediaElement.nodeName.toLowerCase() !== type.toLowerCase()) {
            throw new ArgumentException_1.default("element with id '".concat(mediaElementId, "' must be an ").concat(type, " element"));
        }
        return mediaElement;
    };
    /**
    ...
    BrowserCodeReader.prototype.decodeOnce = function (element, retryIfNotFound, retryIfChecksumOrFormatError) {
        ...
        this._stopAsyncDecode = false;
        var loop = function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var result, e_2, ifNotFound, isChecksumOrFormatError, ifChecksumOrFormat;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.decodeAsync(element)];
                    case 2:
                        result = _a.sent();
                        resolve(result);
                        return [3 /*break*/, 4];
                    case 3:
                        e_2 = _a.sent();
                        ifNotFound = retryIfNotFound && e_2 instanceof NotFoundException_1.default;
                        isChecksumOrFormatError = e_2 instanceof ChecksumException_1.default || e_2 instanceof FormatException_1.default;
                        ifChecksumOrFormat = isChecksumOrFormatError && retryIfChecksumOrFormatError;
                        if (ifNotFound || ifChecksumOrFormat) {
                            // trying again
                            return [2 /*return*/, setTimeout(function () { return void loop(resolve, reject); }, this._timeBetweenDecodingAttempts)];
                        }
                        reject(e_2);
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/];
    ...
    BrowserCodeReader.prototype.decodeContinuously = function (element, callbackFn) {
        ...
        var loop = function () { return __awaiter(_this, void 0, void 0, function () {
            var result, e_3, isChecksumOrFormatError, isNotFound;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        e_3 = _a.sent();
                        callbackFn(null, e_3);
                        isChecksumOrFormatError = e_3 instanceof ChecksumException_1.default || e_3 instanceof FormatException_1.default;
                        isNotFound = e_3 instanceof NotFoundException_1.default;
