...
export class MinimalEncoder {
     ...
     */
    static encodeHighLevel(msg, priorityCharset = null, fnc1 = -1, shape = 0 /* SymbolShapeHint.FORCE_NONE */) {
        let macroId = 0;
    ...
    static getNumberOfC40Words(input, from, c40, characterLength) {
        ...
        for (let i = from; i < input.length(); i++) {
            ...
            if ((c40 && EncoderUtils.isNativeC40(ci)) ||
...
class Edge {
    ...
    getLastASCII() {
        ...
        if (length - from === 2) {
            ...
            if (EncoderUtils.isDigit(this.input.charAt(from)) &&
        ...
        if (length - from === 3) {
            ...
            if (EncoderUtils.isDigit(this.input.charAt(from + 1)) &&
    ...
    getC40Words(c40, fnc1) {
        ...
        for (let i = 0; i < this.characterLength; i++) {
            ...
            if ((c40 && EncoderUtils.isNativeC40(ci)) ||
                ...
                if ((c40 && EncoderUtils.isNativeC40(asciiValue)) ||
