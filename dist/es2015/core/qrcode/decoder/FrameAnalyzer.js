...
export class FrameAnalyzer {
    ...
    isUnstable(density, finderCount) {
    ...
    analyzeDensity(matrix, width, height) {
        let blackCount = 0;
        ...
        const totalSamples = Math.floor((width / this.SAMPLE_STEP) * (height / this.SAMPLE_STEP));
    ...
    analyzeStructure(matrix, width, height) {
    ...
    detectFinderPattern(matrix, startX, startY, step) {
