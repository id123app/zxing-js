...
const WASM_FORMAT_TO_BARCODE_FORMAT = {
...
export class BrowserMultiFormatReader extends BrowserCodeReader {
     ...
     */
    constructor(hints = null, timeBetweenScansMillis = 500, wasmMaxDimension = DEFAULT_WASM_MAX_DIMENSION) {
    ...
    getWasmFormats() {
        ...
        if (!hints)
            return undefined;
        const possibleFormats = hints.get(DecodeHintType.POSSIBLE_FORMATS);
     ...
     */
    getWasmCanvas(srcWidth, srcHeight) {
    ...
    decodeAsync(element) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const possibleFormatsHint = (_a = this._hints) === null || _a === void 0 ? void 0 : _a.get(DecodeHintType.POSSIBLE_FORMATS);
            const callerProvidedFormatsHint = Array.isArray(possibleFormatsHint) && possibleFormatsHint.length > 0;
            ...
            const hasUnmappableHintedFormat = callerProvidedFormatsHint &&
            ...
            try {
                ...
                const runWasm = (formats) => __awaiter(this, void 0, void 0, function* () {
                    const raw = readBarcodes(imageData, Object.assign(Object.assign({}, baseOptions), { formats }));
                    const isPromise = raw != null && typeof raw === 'object' && typeof raw.then === 'function';
                    const resolved = isPromise ? yield raw : raw;
                ...
                const isValidResult = (r) => r.length > 0 && !!r[0] && r[0].isValid &&
                ...
                let results;
                if (wasmFormats) {
                    results = yield runWasm(wasmFormats);
                }
                else {
                    results = yield runWasm(['Matrix-Codes']);
                    if (!isValidResult(results)) {
                        results = yield runWasm(DEFAULT_LINEAR_FORMATS);
                    }
                }
                if (results.length === 0)
                ...
                return new Result(first.text, null, 0, points !== null && points !== void 0 ? points : [], barcodeFormat);
            }
            catch (e) {
     ...
     */
    static extractResultPoints(result, scale) {
        if (!result.position)
            return null;
