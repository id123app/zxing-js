...
export class BrowserCodeReader {
    ...
    decodeOnce(element, retryIfNotFound = true, retryIfChecksumOrFormatError = true) {
        this._stopAsyncDecode = false;
        const loop = (resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield this.decodeAsync(element);
                resolve(result);
            }
            catch (e) {
                ...
                if (ifNotFound || ifChecksumOrFormat) {
                    // trying again
                    return setTimeout(() => void loop(resolve, reject), this._timeBetweenDecodingAttempts);
                }
                reject(e);
            }
        });
