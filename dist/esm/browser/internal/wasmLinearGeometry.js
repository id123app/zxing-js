 ...
 * accidental mutation.
 */
export var DEFAULT_LINEAR_FORMATS = Object.freeze([
 ...
 */
var LINEAR_FORMAT_SET = new Set(DEFAULT_LINEAR_FORMATS);
/**
 ...
 */
export var MIN_LINEAR_ASPECT_RATIO = 1.5;
/**
 ...
 */
export var MAX_LINEAR_CORNER_ANGLE_DEVIATION_DEG = 10;
/**
 ...
 */
export function hasValidLinearGeometry(result) {
    ...
    if (longSide / shortSide < MIN_LINEAR_ASPECT_RATIO)
        return false;
    ...
    if (Math.abs(angleDeg - 90) > MAX_LINEAR_CORNER_ANGLE_DEVIATION_DEG)
        return false;
    return true;
}
