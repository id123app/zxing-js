...
var BrowserQRCodeReader = /** @class */ (function (_super) {
    ...
    function BrowserQRCodeReader(timeBetweenScansMillisOrOptions) {
        ...
        _this = _super.call(this, new QRCodeReader(), timeBetweenScansMillis) || this;
    ...
    BrowserQRCodeReader.getWasmReader = function () {
        ...
        if (typeof readBarcodes === 'function') {
            return { readBarcodes: readBarcodes };
        }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 7:
                        ...
                        return [2 /*return*/, new Result(decodedText, null, 0, safePoints, BarcodeFormat.QR_CODE)];
                    case 8:
                        e_1 = _c.sent();
                        ...
                        if (e_1 instanceof NotFoundException) {
