...
var ASCIIEncoder = /** @class */ (function () {
    ...
    ASCIIEncoder.prototype.encode = function (context) {
        // step B
        var n = EncoderUtils.determineConsecutiveDigitCount(context.getMessage(), context.pos);
        if (n >= 2) {
            ...
            var newMode = EncoderUtils.lookAheadTest(context.getMessage(), context.pos, this.getEncodingMode());
