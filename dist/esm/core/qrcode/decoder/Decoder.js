...
var Decoder = /** @class */ (function () {
    ...
    Decoder.prototype.decodeBitMatrixParser = function (parser, hints) {
        ...
        try {
            for (var dataBlocks_1 = __values(dataBlocks), dataBlocks_1_1 = dataBlocks_1.next(); !dataBlocks_1_1.done; dataBlocks_1_1 = dataBlocks_1.next()) {
                ...
                var blockLen = dataBlock.getCodewords().length;
        ...
        var sharedRsBuffer = this.rsBuffer;
        try {
     ...
     * @throws ChecksumException if error correction fails
     */
    Decoder.prototype.correctErrors = function (codewordBytes, numDataCodewords /*int*/, output, outputOffset, rsBuffer) {
        var length = codewordBytes.length;
        // Use provided buffer (preallocated) or create a temporary one if not provided
        var buffer = rsBuffer && rsBuffer.length >= length ? rsBuffer : new Int32Array(length);
